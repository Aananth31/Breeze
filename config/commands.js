...
var commands = exports.commands = {
	 ...
	 *****************************************************/
	 ...
	 coffee: function(target,room,user) {
	 	if (!this.canBroadcast()) return;
	 	this.sendReplyBox('<center><img src=http://zeus.cooltext.com/rendered/cooltext1542216479.png><br><font color=blue>Illusions hide real illusions... from real illusions, the illusions are created.<br><font color=blue>The truth hides the lie...lie hides the truth. That is the Mist..<br><p align="right">-Mukuro Rokudo.<br><br><font color=red>Once you have eliminated the impossible, whatever remains, <br><font color=red>however improbable, must be the truth.<br><p align="right">-Sherlock Holmes.')
	 },
