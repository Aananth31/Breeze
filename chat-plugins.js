	...
	scavenger: {
		...
		commands: {
			scavengerstarthunt: function(target, room, user) {
				...
				if (room.id !== 'tourneysandgames') return this.sendReply('You can only start scavenger hunts on Scavengers room.');
			...
			scavengerendhunt: function(target, room, user) {
				if (!this.can('ban', null, room)) return false;
				if (room.id !== 'tourneysandgames') return this.sendReply('You can only end scavenger hunts on Scavengers room.');
			...
			scavengerresethunt: function(target, room, user) {
				if (!this.can('ban', null, room)) return false;
				if (room.id !== 'tourneysandgames') return this.sendReply('You can only reset scavenger hunts on Scavengers room.');
